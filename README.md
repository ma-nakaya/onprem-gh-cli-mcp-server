...
> [!IMPORTANT]
> 現在はPhase 2eです。読み取り操作に加え、型付きツールによるIssue、Pull Request、Draft Release、Workflow Dispatch、Label、Milestoneの書き込みを提供します。Repository削除、PRマージ、Release公開、Secret変更などの高影響な管理操作は未実装です。
...
- 監査ログへIssue・Pull Request・Releaseの本文やコメント、Workflow inputs、Label / Milestoneの説明、Token、Secretを保存しない
...
- 未実装: Release公開、Project、削除、PRマージ、Secret、二段階承認
